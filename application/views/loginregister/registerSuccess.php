        ...
        <div class="col-md-12">
            <div class="well well-sm">
                <form class="form-horizontal" method="post" action="<?php echo base_url("index.php/LoginRegister/registerSuccess");?>" enctype="multipart/form-data">
                    <fieldset>
                        <legend class="text-center header"><strong>Your Account Has Been Successfully Registered <br> </strong></legend>
                        <legend class="text-center header"><strong>Now You Can <a href="<?php echo base_url(); ?>index.php/LoginRegister/loginPage">Login</a> Using Your Account </strong></legend>
            </div>
        </div>
    </div>
</div>
