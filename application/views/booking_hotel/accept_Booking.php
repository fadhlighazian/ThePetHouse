    ...
    <div class="row">
        ...
        <img src=<?php echo base_url('assets/images/hotel.jpg');?>
            <div class="well well-sm">
                <form class="form-horizontal" method="post" action="<?php echo base_url("index.php/BookingOrders/bookingAcceptProcess")?>">
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input id="pice" name="price" type="number" class="form-control" placeholder="Estimated Price" required>
                            </div>
                        </div>
