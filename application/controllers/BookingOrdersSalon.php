<?php
	...
	* 
	*/
	class BookingOrdersSalon extends CI_Controller
	{
		...
		public function index()
		{
			if($this->session->userdata('username') == "admin")
			{
				...
				$data['booking'] = $this->booking_orders_model_salon->get_booking();
				$data['confirmedBooking'] = $this->booking_orders_model_salon->get_confirmed_booking();
		...
		public function bookingAccept()
		{
            ...
            $data['typesalon'] = $this->input->post('typesalon');  
			...
			$data['header'] = $this->load->view('templates/headerAdmin.php', NULL, TRUE);
			$data['footer'] = $this->load->view('templates/footer.php', NULL, TRUE);
			$this->load->view('booking_salon/accept_Booking_Salon.php', $data);
		}
		...
		public function bookingAcceptProcess()
		{
			...
			$this->booking_orders_model_salon->confirmedOrderInsert($idOrder,$Name, $furname, $address, $email, $phone, $checkin, $typesalon, $userNotes, $idOrderSS);
			$this->booking_orders_model_salon->bookingMoved($idOrder);
			...
			*/
			...
			$htmlContent .= '										<p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">Your Salon Booking Has Been Confirmed</p>';
			...
			$htmlContent .= '										<p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">Type Salon & Price      : ' . $typesalon . '</p>';
			...
			*/
			...
			if ($this->email->send()){
				...
				redirect('/BookingOrdersSalon/index');
			}else{
		...
		public function bookingDecline()
		{
			...
			$data['header'] = $this->load->view('templates/headerAdmin.php', NULL, TRUE);
			$data['footer'] = $this->load->view('templates/footer.php', NULL, TRUE);
			$this->load->view('booking_salon/decline_Booking_Salon.php', $data);
		}
		...
		public function bookingDeclineProcess()
		{
			...
			$this->booking_orders_model_salon->declineOrder($idOrder);
			...
			*/
			...
			$htmlContent .= '									<td style="font-family: sans-serif; font-size: 14px; vertical-align: top;">';
			$htmlContent .= '										<p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">Dear Mr/Mrs.'; $htmlContent .= $Name . ' , </p>';
			$htmlContent .= '										<p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">Your Salon Booking Has Been Declined</p>';
			$htmlContent .= '										<table border="0" cellpadding="0" cellspacing="0" class="btn btn-primary" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%; box-sizing: border-box;">';
			$htmlContent .= '										<tbody>';
			$htmlContent .= '											<tr>';
			$htmlContent .= '											<td align="left" style="font-family: sans-serif; font-size: 14px; vertical-align: top; padding-bottom: 15px;">';
		...
		public function ordersSalonComplete(){
			...
			$this->booking_orders_model_salon->insertHistory($idOrder,$Name, $furname, $address, $email, $phone, $checkin, $typesalon, $userNotes, $idUser);
			$this->booking_orders_model_salon->bookingCompleted($idOrder);
			// load email library
			$this->load->library('email');
			...
			*/
			...
			$htmlContent .= '									<td style="font-family: sans-serif; font-size: 14px; vertical-align: top;">';
			$htmlContent .= '										<p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">Dear Mr/Mrs.'; $htmlContent .= $Name . ' , </p>';
			$htmlContent .= '										<p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">Your Salon Booking Has Been Completed</p>';
			$htmlContent .= '										<table border="0" cellpadding="0" cellspacing="0" class="btn btn-primary" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%; box-sizing: border-box;">';
			$htmlContent .= '										<tbody>';
			$htmlContent .= '											<tr>';
			$htmlContent .= '											<td align="left" style="font-family: sans-serif; font-size: 14px; vertical-align: top; padding-bottom: 15px;">';
